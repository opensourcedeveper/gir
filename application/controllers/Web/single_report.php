...
?>
    <!-- BREADCRUMB -->
        ...
        <nav aria-label="breadcrumb pl-0">
            ...
            <!-- <li class="breadcrumb-item active" aria-current="page"><?=substr($Record['title'],0,250); ?></li> -->
            </ol>
        </nav>
        </div>
        <!--  -->
            ...
            <div class="mwidth">
                <div class="">
                    <div class="rdiscHead">
                        ...
                        <p> <a id="" href="<?= base_url() ?>request-sample/<?= $Record['slug'] ?>" class="rdredsamMob">Request Sample <i class="fa fa-envelope pl-2"></i></a></p>
                    </div>
                        ...
                        <div class="reportDesc">
                           ...
                           <!-- Note: New place of `data-parent` -->
                                    <div id="collapse-A" class="collapse show" data-parent="#content" role="tabpanel" aria-labelledby="heading-A">
                                        <div class="card-body">
                                            <!-- <p>Description</p> -->
                                           <pre style="background-color: transparent; border: none; font-size: 15px; font-family: 'Open Sans', sans-serif;;white-space: normal; ">

                                            <?= $Record['report_desc'] ?>   </pre>
                    ...
                    <div class="col-md-3">
                        <div>
                            ...
                            <div class="rdsrightFormsBox mt-4">
                                ...
                                <!-- <a href="#" class="bg-prime">Discount <i class="fa fa-percent pl-2"></i> </a> -->
                            </div>
                            <!--  -->
