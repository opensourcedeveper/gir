...
class Controller_PressRelease extends Cust_Controller 
{
	...
	*/
	public function index()
	{
		...
		$this->render_template('cust/pr-listing', $this->data);
	}
	public function details($blog_id = false)
	{
		$this->data['pressrelease_data'] = $this->model_pressrelease->getPressReleaseData($blog_id);
		$this->data['users_data'] = $this->model_users->getUserData($this->data['pressrelease_data']['created_by']);
		$this->data['page_title'] = '';
		$this->data['meta_title'] = $this->data['pressrelease_data']['metaTitle'];
		$this->render_template('cust/pr-details', $this->data);
	}
	public function details2($slug = false)
	{
		$this->data['pressrelease_data'] = $this->model_pressrelease->getPressReleaseData2($slug);
		$this->data['users_data'] = $this->model_users->getUserData($this->data['pressrelease_data']['created_by']);
		$this->data['page_title'] = '';
		$this->data['meta_title'] = $this->data['pressrelease_data']['metaTitle'];
		$this->render_template('cust/pr-details', $this->data);
	...
	*/
	public function remove()
	{
		...
		$response = array();
		if($product_id) {
			$delete = $this->model_PressRelease->remove($product_id);
			if($delete == true) {
