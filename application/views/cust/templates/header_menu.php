                   ...
                   <?php foreach ($headermenu as $cat) {
                    ...
                    <div class="col-md-4">
                      ...
                      <ul class="nav flex-column">
                        <li class="nav-item">
                          <a class="nav-link pt-1 pb-1 active" href="<?php echo base_url('categories/'.$cat['slug']) ?>">
                            <i class="fa <?php echo $icon;?> f23 pr-2"></i> <?php echo $cat['name'];?>
                          </a>
                        </li>
             <!--       <li class="nav-item">
...
<h1 class="pthTitle"><?php echo $page_title != "" ? $page_title: ""?></h1>
<!--  -->
