        ...
        <div class="row justify-content-center">
            <div class="col-sm-12 col-md-12">
                <div class="singleBlog">
                      ...
                      <h4 class="prime-color"><?php echo $pressrelease_data['title']?></h4>
                      <!-- <p class="op05 f11 pt-2"><i class="fa fa-user pr-2"></i><span><?php echo $users_data['firstname']?></span></p>
                      <p><i class="fa fa-calendar pr-2"></i><?php echo $pressrelease_data['created_at']?></p> -->
                      <div class="d-flex pt-2">

                      <p class="f11"><i class="fa fa-user pr-2"></i><span><?php echo $users_data['firstname']?></span></p>
                      <p class="pl-3 op05  f11"><i class="fa fa-calendar pr-2"></i><?php echo $pressrelease_data['created_at']?></p>
                      </div>
                      <div class="pt-3">
                          <!--<p><?php // echo $pressrelease_data['description']?></p>-->
                          <div class="singleBlogImg text-center">
                            <img src="<?php echo base_url($pressrelease_data['image']) ?>" alt="" class="" >
                          </div>
                            <p class="pt-4"><?php echo $pressrelease_data['description']?></p>
                    </div>
                </div>
            </div>
