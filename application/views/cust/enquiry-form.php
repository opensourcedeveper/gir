...
<body>
    ...
    <section class="pb-5 formImage pt-5">
        <div class="container">
            ...
            <div class="row pt-5">
                <div class="col-md-6">
                <h1 class="f20 clrfff"><?php echo $reports_data['title'];?></h1>
                ...
                <div class="col-md-6 bg-prime bx-shadow2">
                    <div class="pt-3 pb-5">
                        <form role="form" id="withCaptchaForm" action="<?php echo base_url('Cust/Controller_Report/enquiryform_request')?>" method="post" enctype="multipart/form-data">
                        <?php // echo form_open( base_url('Cust/Controller_Report/sample_request')); ?>
                        
                            <h4 class="f24 text-center clrfff pt-2">ENQUIRY</h4> 
                            ...
                            <input type="hidden" class="form-control" id="type" name="type" value="enquiry">
