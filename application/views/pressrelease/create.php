    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          ...
          <!-- /.box-header -->
          <form role="form" action="<?php base_url('press-release/create') ?>" method="post" enctype="multipart/form-data">
             <!--<div class="box-body">-->
            ...
            <div class="card-body pad">
              ...
              <div class="mb-3">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="pressreleaseTitle" name="pressreleaseTitle" placeholder="Enter pressrelease Title">
                </div>
              </div>
...
<!--              <div class="mb-3">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="slug" name="slug" placeholder="Enter pressrelease slug">
                </div>
              </div>-->
            ...
            <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <textarea class="form-control ckeditor" placeholder="Place some text here" id="pressreleaseDescription" name="pressreleaseDescription"
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $("#addPressReleaseNav").addClass('active');
