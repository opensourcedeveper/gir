...
<!--                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="qty" name="qty" placeholder="Enter Qty" readonly="" value="<?php echo $product_data['qty']; ?>" autocomplete="off" />
                </div>
                  ...
                  <?php foreach ($attributes as $k => $v): ?>
                    <div class="form-group">
                      ...
                      <select class="form-control select_group" id="attributes_value_id" name="attributes_value_id[]" multiple="multiple">
                        <?php if(!empty($attribute_id)){ foreach ($v['attribute_value'] as $k2 => $v2): ?>
...
<!--                <div class="form-group">
                  ...
                  <select class="form-control select_group" id="brands" name="brands[]" multiple="multiple">
                    <?php // if(!empty($brand_data)){foreach ($brands as $k => $v): ?>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control select_group" id="category" name="category[]" multiple="multiple">
                    <?php if(!empty($category_data)){ foreach ($category as $k => $v): ?>
